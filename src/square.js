...
export default class Square extends Base {
  ...
  handleMasterCheckbox (e) {
    const items = document.querySelectorAll(`${this.getProperty('selector')}.checkbox-beautify--slave`)
    ...
    for (const item of items) {
      ...
      const placeholder = item.parentElement.querySelector('.checkbox-beautify-placeholder-inner')
